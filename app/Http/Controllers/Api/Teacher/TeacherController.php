...
// dd($request->user_type);
        if (Auth::attempt(['email' => $request->email, 'password' => $request->password, 'user_type' => 'teacher'])) {
        ...
        if ($authenticatedUser) {
            ...
            if ($teacher) {
                ...
                $homeworkData = $homeworks->map(function ($homework) {
                    return [
                        'first_name' => optional($homework->teacher->user)->first_name,
                ...
                return response()->json([
                    'user' => [
                        'first_name' => optional($teacher->user)->first_name,
